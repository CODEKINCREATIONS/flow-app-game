...
export default function Button({
  ...
  const baseClasses =
    ...
    "hover:scale-[1.02] disabled:cursor-not-allowed flex items-center justify-center text-white";
  ...
  const variantClasses =
    variant === "danger"
      ...
      : "bg-gradient-to-r from-[#7B61FF] to-[#3A8DFF] hover:shadow-[0_0_20px_#3A8DFF] rounded-[0.35rem] border-2 border-[#7B61FF] ring-1 ring-[#7B61FF]";
